...
<body>
	...
	<div class="userStatistic-info" style="margin-bottom: 10px">
		<div class="demo-tip icon-tip">&nbsp;</div>
		<div>You can see user sales statistics here.</div>
	</div>

	<table id="dg" title="User Sale Statistics" class="easyui-datagrid"
		style="width: 700px; height: 250px" url="showUserStatistic.action"
		toolbar="#toolbar" rownumbers="true"
		fitColumns="true" singleSelect="true">
		<thead>
			<tr>
				<th field="key" width="50">Username</th>
